/**
 * Landing page (`/`): hero, the playable demo wheel, the three steps, features,
 * popular public wheels and the closing call to action.
 *
 * Owner: whoever is working on the landing page. See ./README.md for how the
 * namespaces fit together and why each file may only use its own prefixes.
 */
...
export const zh = {
  ...
  "demo.saveCta": "用你附近的店建一個自己的輪盤",
  "demo.saveTyped": "登入後保留你加的 {n} 家，建立你的輪盤",
  "demo.listLabel": "這輪的候選",
  "demo.duplicate": "這家已經在候選裡了",
  "demo.full": "最多 {max} 家，移除一家就能再加",
  ...
  "steps.2.title": "勾選",
  "steps.2.desc": "附近營業中的店預設幫你勾好，不想吃的取消就好",
  "steps.3.title": "開轉",
...
export const en: Record<keyof typeof zh, string> = {
  ...
  "demo.saveCta": "Build your own wheel from places near you",
  "demo.saveTyped": "Sign in and keep the {n} you added",
  "demo.listLabel": "On the wheel",
  "demo.duplicate": "That one's already on the wheel",
  "demo.full": "{max} at most. Remove one to add another",
  ...
  "steps.2.title": "Pick",
  "steps.2.desc": "The nearest open places arrive ticked — untick what you don't want",
  "steps.3.title": "Spin",
